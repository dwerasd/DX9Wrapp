...
namespace dx9
{
		...
		: public D3DXVECTOR4
	{
		...
		_DVECTOR4 operator/(const float _v) const { float i=(float)1.0/_v; return _DVECTOR4(x * i, y * i, z * i, w * i);	}
		_DVECTOR4& operator/=(const float _v) { float i=(float)1.0/_v; x*=i; y*=i; z*=i; w*= i; return *this; }
...
static inline dx9::DVECTOR4 operator+(const dx9::DVECTOR4& lhs, const dx9::DVECTOR4& rhs)            { return dx9::DVECTOR4(lhs.x+rhs.x, lhs.y+rhs.y, lhs.z+rhs.z, lhs.w+rhs.w); }
static inline dx9::DVECTOR4 operator-(const dx9::DVECTOR4& lhs, const dx9::DVECTOR4& rhs)            { return dx9::DVECTOR4(lhs.x-rhs.x, lhs.y-rhs.y, lhs.z-rhs.z, lhs.w-rhs.w); }
static inline dx9::DVECTOR4 operator*(const dx9::DVECTOR4& lhs, const dx9::DVECTOR4& rhs)            { return dx9::DVECTOR4(lhs.x*rhs.x, lhs.y*rhs.y, lhs.z*rhs.z, lhs.w*rhs.w); }
